<div class="ContenedorProximosEventos">
  ...
  <div class="carousel-caption d-flex flex-column justify-content-center align-items-center" style="height: 100%; top: 0; bottom: 0; left: 0; right: 0;">
    ...
    <div class="contenedorImage1Text">
      <h5 class="tipografiaImage1Text slide-title">Avances recientes en HCI y su impacto en la tecnología moderna</h5>
    </div>
    <!-- Texto adicional -->
    ...
    <div class="carousel-item" data-id="slide-2">
      ...
      <div class="carousel-caption d-flex flex-column justify-content-center align-items-center" style="height: 100%; top: 0; bottom: 0; left: 0; right: 0;">
        ...
        <div class="contenedorImage2Text">
          <h5 class="tipografiaImage2Text slide-title">Tendencias emergentes en la interacción humano-computadora</h5>
        </div>
    ...
    <div class="carousel-item" data-id="slide-3">
      ...
      <div class="carousel-caption d-flex flex-column justify-content-center align-items-center" style="height: 100%; top: 0; bottom: 0; left: 0; right: 0;">
        ...
        <div class="contenedorImage3Text">
          <h5 class="tipografiaImage3Text slide-title">Desafíos y soluciones en la usabilidad de aplicaciones móviles</h5>
        </div>
    ...
    <div class="carousel-item" data-id="slide-4">
      ...
      <div class="carousel-caption d-flex flex-column justify-content-center align-items-center" style="height: 100%; top: 0; bottom: 0; left: 0; right: 0;">
        ...
        <div class="contenedorImage4Text">
          <h5 class="tipografiaImage4Text slide-title">Como mejorar la retención de usuarios en aplicaciones móviles</h5>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  myCarouselElement.addEventListener('slid.bs.carousel', () => {
    slides.forEach(slide => {
      ...
      // No reiniciar estados al cambiar de slide
      // El estado permanece según lo definido por el clic
    });
  });
});
