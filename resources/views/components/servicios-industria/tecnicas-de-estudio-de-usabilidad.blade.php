...
<div class="tecnicasDeEstudioDeUsabilidadContainer">
    <!-- Contenedor del título de la sección -->    
    <div class="tecnicasDeEstudioDeUsabilidadTitleContainer">
        <!-- Título de la sección -->
        <div class="tecnicasDeEstudioDeUsabilidadTitle"> Técnicas para llevar a cabo los estudios de usabilidad</div>
    </div>
    <!-- Texto de la sección -->
    ...
    <!-- Contenedor de las card de técnicas -->
     <div class="tecnicasDeEstudioDeUsabilidadCardsContainer">
        ...
        <div class="tecnicasDeEstudioDeUsabilidadCards">
            <!-- Título de la card -->
            <div class="tecnicasDeEstudioDeUsabilidadCardTitle">Evaluación Heurística</div>
            <!-- Texto de la card -->
            <div class="tecnicasDeEstudioDeUsabilidadCardText">Método se basa en una revisión experta de la interfaz de usuario, comparándola con principios de usabilidad reconocidos</div>
        </div>
